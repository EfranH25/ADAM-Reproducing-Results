...
def main(mini_batch_size, learning_rate, weight_decay, epochs, patch_size=4):
    ...
    for optimizer_name in optimizer_options:
        ...
        model = VisionTransformer(image_size=test_images.shape[2],
    ...
    build_graphs(result_list, epochs, name="CIFAR10 Vision Transformer")
